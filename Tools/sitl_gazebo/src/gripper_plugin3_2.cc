...
namespace gazebo
{
	...
	class GripperROSPlugin2 : public ModelPlugin
	{
    		/// \brief Constructor
		public: GripperROSPlugin2() {}
...
//        		_model->GetJointCount() << "]\n";
			...
			if (!ros::isInitialized())
			{
  				int argc = 0;
  				char **argv = NULL;
  				ros::init(argc, argv, "gazebo_manipulator_client_gripper_2",
	...
	// Tell Gazebo about this plugin, so that Gazebo can call Load on this plugin.
 	GZ_REGISTER_MODEL_PLUGIN(GripperROSPlugin2)
}
#endif
