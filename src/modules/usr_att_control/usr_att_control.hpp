...
private:
    ...
    DEFINE_PARAMETERS(
            ...
            (ParamFloat<px4::params::USR_LAMMDA_Q_X>) _param_usr_lambda_q_x,
            (ParamFloat<px4::params::USR_LAMMDA_Q_Y>) _param_usr_lambda_q_y,
            (ParamFloat<px4::params::USR_LAMMDA_Q_Z>) _param_usr_lambda_q_z,

            (ParamFloat<px4::params::USR_KQ>) _param_usr_Kq,

            (ParamFloat<px4::params::USR_K_OMEGA_X>) _param_usr_k_omega_x,
            (ParamFloat<px4::params::USR_K_OMEGA_Y>) _param_usr_k_omega_y,
            (ParamFloat<px4::params::USR_K_OMEGA_Z>) _param_usr_k_omega_z,

            /* parameters for ESO */
            (ParamFloat<px4::params::USR_ESO_X>) _param_usr_eso_gain_x,
            (ParamFloat<px4::params::USR_ESO_Y>) _param_usr_eso_gain_y,
            (ParamFloat<px4::params::USR_ESO_Z>) _param_usr_eso_gain_z,
